...
// let arr = [1, 2, 3, 4, 5];
// function arrReturn(arr, index1){
//     return arr.find((element, index2) => {
//         return 
//     })
// }
...
//     return str.repeat().split('').sort((letter) => {

//     })
    
    
// }
// let repeats = repeatsLetter('Hello');
// console.log(repeats);
